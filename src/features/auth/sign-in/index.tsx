    ...
    return (
      <AuthLayout>
        <div className="space-y-3">
          <Card className="gap-4">
            <CardContent className="py-12">
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">You&apos;ll be able to sign in once your request is approved. Check your email for updates.</p>
                <div className="pt-4">
          ...
          <div className="text-center text-xs text-muted-foreground">v{__APP_VERSION__}</div>
        </div>
      </AuthLayout>
    );
  }
      ...
      <div className="space-y-3">
        <Card className="gap-4">
          <CardHeader>
            ...
            <CardDescription>
              {new_user ? "Signed in with Google! Enter an invite code to join a community." : "Sign in with email and password, or continue with Google."}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {error === "approval_pending" && (
              <Alert className="mb-4">
                <AlertDescription>Your request to join is still pending approval. Please wait for an admin to approve your account.</AlertDescription>
              </Alert>
            )}
          ...
          {!new_user && (
            <CardFooter>
              <p className="text-muted-foreground px-8 text-center text-sm">
                New here?{" "}
                <a href="/api/auth/google/start" className="hover:text-primary underline underline-offset-4">
                  Sign in with Google
                </a>{" "}
                to get started
              </p>
