  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn("relative has-focus:border-ring border border-input shadow-xs has-focus:ring-ring/50 has-focus:ring-2 rounded-md", defaultClassNames.dropdown_root),
